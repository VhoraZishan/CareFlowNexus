...
const NewPatient = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        medical_history: '', reason: '', special_needs: ''
    });
                    ...
                    <form onSubmit={handleSubmit}>
                        <section className="form-section">
                            ...
                            <div className="form-grid">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="e.g. Jonathan Doe" required />
                                </div>
                                <div className="form-group">
                                    <label>AGE</label>
                        ...
                        <section className="form-section">
                            ...
                            <div className="form-group full-width">
                                ...
                                <textarea name="reason" value={formData.reason} onChange={handleChange} placeholder="Describe the acute problem or reason for this admission..."></textarea>
                            </div>
                            <div className="form-group full-width">
                                <label>MEDICAL HISTORY</label>
                                <textarea name="medical_history" value={formData.medical_history} onChange={handleChange} placeholder="Briefly describe previous conditions, surgeries, or chronic illnesses..."></textarea>
                            </div>
                            <div className="form-group full-width">
                                <label>SPECIAL NEEDS / ALLERGIES</label>
                                <textarea name="special_needs" value={formData.special_needs} onChange={handleChange} placeholder="Mention any mobility requirements, diet restrictions, or medication allergies..."></textarea>
                            </div>
                        </section>

                        <div className="form-footer-action">
                            <span className="notice">ℹ️ System will auto-assign a room upon submission</span>
