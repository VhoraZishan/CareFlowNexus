                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="search-section">
                            ...
                            <div className="search-wrapper-premium">
                                <input
                                    type="text"
                                    placeholder="Type patient name (e.g. Jonathan)..."
                            ...
                            <div className="patient-info-display animate-fade-in">
                                ...
                                <div className="info-grid">
                                    ...
                                    <div className="info-item full-width">
                                        ...
                                        <p>{selectedPatient.special_needs?.join(', ') || 'None'}</p>
                                    </div>
                                </div>
                            </div>
                        )}
                                    ...
                                    <div className="disease-tags">
                                        {getVisibleDiseases().map(disease => (
                                            <button
                                                key={disease}
                                                type="button"
                                                className={`disease-tag ${admissionData.diagnosis.includes(disease) ? 'active' : ''}`}
